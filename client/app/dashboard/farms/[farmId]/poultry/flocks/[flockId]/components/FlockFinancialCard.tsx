...
export function FlockFinancialCard({ flock }: FlockFinancialCardProps) {
  ...
  const costPerBird =
    flock.currentCount > 0 ? totalCost / flock.currentCount : 0;
  const revenuePerBird =
    flock.currentCount > 0 ? totalRevenue / flock.currentCount : 0;
        ...
        <div className="rounded-lg bg-muted/30 p-3">
          ...
          <div className="flex justify-between text-sm">
            ...
            <span className="font-semibold">
              KES {flock.breakEvenTarget.toLocaleString()}
            </span>
          </div>
          <div className="flex justify-between text-sm mt-1">
            ...
            <span
              className={cn(
                "font-semibold",
                netProfit >= flock.breakEvenTarget
                  ? "text-emerald-600"
                  : "text-amber-600",
              )}
            >
